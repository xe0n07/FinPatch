...
const Register = () => {
  ...
  const password = watch('customerPassword');

  const onSubmit = async (data) => {
    setLoading(true);
    setErrorMsg('');
    try {
      await registerUser(data.customerName, data.email, data.customerPassword, data.confirmPassword);
      navigate('/onboarding');
    } catch (e) {
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
          <div>
            ...
            <input
              ...
              disabled={loading}
              {...register('customerName', { required: 'Username is required' })}
            />
          ...
          <div>
            ...
            <div className="relative">
              ...
              />
              <button type="button" onClick={() => setShowPass(!showPass)} className="absolute right-3 top-1/2 -translate-y-1/2 text-muted hover:text-text-secondary transition-colors">
          ...
          <div>
            ...
            <div className="relative">
              ...
              />
              <button type="button" onClick={() => setShowConfirm(!showConfirm)} className="absolute right-3 top-1/2 -translate-y-1/2 text-muted hover:text-text-secondary transition-colors">
